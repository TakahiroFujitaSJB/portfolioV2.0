...
const Work = () => {
  ...
  return (
    <div name='work' className='w-full md:h-screen pt-20 text-gray-300 bg-gradient-to-b from-[#b503fc] via-[#3326a8] to-[#0a192f]'>
...
<div className="grid sm:grid-cols-2 md:grid-cols-3 gap-[150px] ">
